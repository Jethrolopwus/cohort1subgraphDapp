...
const Footer = () => {
  return (
    <div className="w-full bg-primary-400 p-4">
      ...
      <div className="border-t border-primary-500 mt-8 pt-4 flex md:flex-row justify-between text-sm sm:text-base text-gray-400">
        <p className="mb-6 md:mb-0">
          Copyright © 2024 Blockfuse Labs . All
          Rights Reserved.{" "}
        </p>
